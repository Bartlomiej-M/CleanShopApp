...
public class Products_promotion extends AppCompatActivity {
        TextView main_toolbar_text;
    DrawerLayout drawerLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_products_promotion);

        drawerLayout = findViewById(R.id.drawer_layout);
        main_toolbar_text = findViewById(R.id.main_toolbar_Text);
        main_toolbar_text.setText("Products on promotion");
    }
    ////////////////////////////////////////////////////////////////////Navigation Drawer////////////////////////////////////////////////////////////////////
