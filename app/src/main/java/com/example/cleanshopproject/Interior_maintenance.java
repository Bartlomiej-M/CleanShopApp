...
public class Interior_maintenance extends AppCompatActivity {
        TextView main_toolbar_text;
    DrawerLayout drawerLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_interior_maintenance);
        drawerLayout = findViewById(R.id.drawer_layout);
        main_toolbar_text = findViewById(R.id.main_toolbar_Text);
        main_toolbar_text.setText("Interior Maintenance");
    }
    ////////////////////////////////////////////////////////////////////Navigation Drawer////////////////////////////////////////////////////////////////////
